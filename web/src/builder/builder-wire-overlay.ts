...
import { builderWireStrokeHex } from "./wire-colors";
...
export type BuilderWireOverlayOptions = {
  ...
  /** Index 0..7 for in-progress link drag stroke; committed links use per-link color from state. */
  getActiveWireColorIndex: () => number;
